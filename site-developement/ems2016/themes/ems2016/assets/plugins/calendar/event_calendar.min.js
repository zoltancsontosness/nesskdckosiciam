...
$.fn.event_calendar = function(b) {
    var c = $.extend({}, $.fn.event_calendar_defaults(), b);
    var a = { month_labels: ["Január", "Február", "Marec", "Apríl", "Máj", "Jún", "Júl", "August", "September", "Október", "November", "December"], dow_labels: ["Po", "Ut", "St", "Št", "Pia", "So", "Ne"] };
    c = $.extend({}, c, a);
    this.each(function() {
        var j = $(this);
        j.attr("id", "event_calendar_" + Math.floor(Math.random() * 99999).toString(36));
        ...
        function l() {
            ...
            $legendObj = g(j);
            var z = $('<div class="event_calendar" id="' + j.attr("id") + '"></div>');
            z.append($tableObj);
            z.append($legendObj);
            j.append(z);
        ...
        function h(B, H, G, J, date) {
            var dateArray = date.split("-")
            var I = $('<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>');
            var A = $('<h4 class="modal-title" id="' + B + '_modal_title"> Podujatia ' + dateArray[2] + '.' + dateArray[1] + '.' + dateArray[0] + "</h4>");
            ...
            //if (typeof(J) !== "undefined") {
                var z = $("<div>" + '<a href="http://www.emskosice.sk/podujatia" class="button button_type_icon_small button_grey_light view_button">Zobraziť všetky podujatia</a>' + "</div>");
                E.append(z)
            //}
                ...
                $(y).each(function(H, J) {
                    ...
                    if (typeof(J.body) !== "undefined") {
                        ...
                        if (I === true) {
                            ...
                            var L = h(D, J.title, J.body, J.footer, J.date);
                            $("body").append(L);
                            $("#" + D).click(function() {
                                $("#" + D + "_modal").modal()
                            })
...
$.fn.event_calendar_defaults = function() {
    var a = new Date();
    var c = a.getFullYear();
    var e = a.getMonth() + 1;
    var b = {
