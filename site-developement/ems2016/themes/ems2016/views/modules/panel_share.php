<div class="section" data-appear-animation="fadeInDown" data-appear-animation-delay="350">
  ...
  <ul class="social_media_list clearfix socials-list">
    ...
    <li>
      <a href="http://twitter.com/intent/tweet?status=<ion:article:title />+<ion:article:url />" target="_blank" class="twitter">
...
<!--
    <li>
      <a href="https://plus.google.com/share?url=<ion:article:url />" target="_blank" class="g_plus">
