...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: Po 23.Feb 2015, 14:44
...
('sk', 18, 'Začiatok &scaron;portov&eacute;ho dňa ', '', ''),
('sk', 19, 'Volejbalov&yacute; z&aacute;pas ', '', ''),
('sk', 20, '&scaron;kolsk&eacute; pole kukurice pred žatvou ', '', ''),
('sk', 21, 'Such&eacute; koryto rieky pri &scaron;kole ', '', ''),
('sk', 22, '&Scaron;kolsk&aacute; kuchyňa Yedidia ', '', ''),
('sk', 23, 'V&yacute;uka v rozostavanej budove ', '', ''),
('sk', 24, 'Triedy je potrebn&eacute; vybaviť n&aacute;bytkom ', '', ''),
('sk', 25, 'Voda sa naber&aacute; v noci ', '', ''),
