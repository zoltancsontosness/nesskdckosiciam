...
<html lang="<ion:current_lang />">
  <head>
    ...
    <!-- font-Awesome -->
    <script>$(function(){if("<ion:url />" != "<ion:home_url />"){$( "#headerDiv" ).removeClass().addClass( "header_bg1" );}});</script> 
  </head>
...
<div class="header_bg" id="headerDiv">
    <div class="container">
        <div class="row header">
            <div class="logo navbar-left">
              <a href="<ion:home_url />"><img alt="Deti Afriky" style="max-width: 100%; max-height: 90px;" src="<ion:theme_url/>assets/images/logo.png"></a>
            </div>
