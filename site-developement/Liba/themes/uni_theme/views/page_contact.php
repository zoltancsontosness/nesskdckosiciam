<ion:partial view="header" />
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <script type="text/javascript"> function init_map(){var myOptions = {zoom:15,center:new google.maps.LatLng(48.7184123,21.21552930000007),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(48.7184123, 21.21552930000007)});infowindow = new google.maps.InfoWindow({content:"<b>Dom &#318;udov&eacute;ho tanca</b><br/> Starozagorsk&aacute; 10 <br/> 040 23  Ko&scaron;ice" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
        <br />
      </div>
    </div>
    <div class="row">
