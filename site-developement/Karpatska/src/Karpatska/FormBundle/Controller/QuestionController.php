...
use Karpatska\FormBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KarpatskaFormBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("KarpatskaFormBundle:Question:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KarpatskaFormBundle:Question')->find($id);
